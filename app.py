...
class App:
    ...
    def __init__(self, window=tk.Tk(), window_title="Object Detector"):
    ...
    def init_gui(self):
        ...
        self.canvas = tk.Canvas(self.window, width=self.camera.width, height=self.camera.heigth)
        self.canvas.pack()

        self.btn_toggleauto = tk.Button(self.window, text="Auto Prediction", width=50, command=self.auto_predict_toggle)
        self.btn_toggleauto.pack(anchor=tk.CENTER, expand=True)

        self.classname_one = simpledialog.askstring("Classname One", "Enter the name of the first object:", parent=self.window)
        self.classname_two = simpledialog.askstring("Classname Two", "Enter the name of the second object:", parent=self.window)
        self.classname_three = simpledialog.askstring("Classname Three", "Enter the name of the third object:", parent=self.window)
